...
-- The function "d" can be used for all the rest. Its first form is to just pass it a number, in which case it will have faces 1 up to that number, all equiprobable. The "dN" version is just a shortcut for d(N).
